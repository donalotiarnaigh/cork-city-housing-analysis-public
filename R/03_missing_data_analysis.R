...
airbnb_cork <- readr::read_csv("data/processed/airbnb_cleaned_corkCity.csv",
...
# Save the plot
ggsave("output/missing_data_summary.png", missing_plot, width = 10, height = 8)
...
write.csv(missing_summary, "output/missing_data_summary.csv", row.names = FALSE)
write.csv(missing_by_year, "output/missing_by_year.csv", row.names = FALSE)
write.csv(missing_by_property_type, "output/missing_by_property_type.csv", row.names = FALSE)
write.csv(missing_by_location, "output/missing_by_location.csv", row.names = FALSE)
write.csv(missing_by_host, "output/missing_by_host.csv", row.names = FALSE)
