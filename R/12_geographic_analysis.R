...
airbnb_path <- "data/processed/final/airbnb_cork_complete.csv"
lea_boundary_path <- "data/boundaries/CSO_Local_Electoral_Areas_National_Statistical_Boundaries_2022_Ungeneralised_view_-2156783281817775184.gpkg"
urban_boundary_path <- "data/boundaries/Urban_Areas_National_Statistical_Boundaries_2022_Ungeneralised_View_1807155406692103826.gpkg"
...
st_write(cork_city_boundary, "data/boundaries/cork_city_boundary.gpkg", delete_layer = TRUE)
...
st_write(airbnb_cork_city, "data/processed/final/airbnb_corkCity.gpkg", delete_layer = TRUE)
...
st_write(airbnb_sf, "data/processed/airbnb_geocoded.gpkg", delete_layer = TRUE)
