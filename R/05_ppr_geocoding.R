...
ppr_clean <- read_csv("data/processed/ppr_cleaned.csv", show_col_types = FALSE)
...
progress_file <- "output/ppr_geocoded_progress.csv"
...
# Save final results
write_csv(geocoded_results, "output/ppr_geocoded.csv")
st_write(ppr_sf, "output/ppr_geocoded.gpkg")
