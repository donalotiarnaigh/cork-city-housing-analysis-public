...
# Set paths
cleaned_csv_path <- "data/processed/airbnb_cleaned_corkCity.csv"
spatial_gpkg_path <- "data/processed/final/airbnb_corkCity.gpkg"
output_gpkg_path <- "data/processed/final/airbnb_corkCity_with_price.gpkg"
output_csv_path <- "data/processed/final/airbnb_corkCity_with_price.csv"
...
cat("- airbnb_path <- \"data/processed/final/airbnb_corkCity_with_price.gpkg\"\n") 