...
# Import PPR data
ppr_data <- read_csv(file.path(base_path, here(here("data/processed/ppr_corkCity.csv"))))
...
write_csv(ppr_standardized, 
          file.path(base_path, here(here("data/processed/ppr_corkCity_standardized.csv"))))
