...
# Set paths
ppr_csv_path <- here(here("data/processed/final/ppr_corkCity.csv"))
airbnb_spatial_path <- here(here("data/processed/final/airbnb_corkCity_with_price.gpkg"))
boundary_path <- here(here("data/boundaries/cork_city_boundary.gpkg"))
output_dir <- here(here("output/price_maps"))
