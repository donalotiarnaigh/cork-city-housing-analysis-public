...
airbnb_path <- here(here("data/processed/final/airbnb_corkCity_with_price.gpkg"))
output_dir <- here(here("output/statistics"))
viz_dir <- here(here("output/visualizations"))
