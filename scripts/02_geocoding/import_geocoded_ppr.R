...
# Import shapefile
ppr_geocoded <- st_read(file.path(base_path, here(here("data/processed/ppr_geocoded_features.shp"))))
...
st_write(ppr_geocoded, 
         file.path(base_path, here(here("data/processed/ppr_geocoded.gpkg"))),
         delete_layer = TRUE)
...
write_csv(ppr_geocoded_csv, 
          file.path(base_path, here(here("data/processed/ppr_geocoded.csv"))))
