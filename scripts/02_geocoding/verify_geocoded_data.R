...
# Import cleaned data
ppr_clean <- st_read(file.path(base_path, here(here("data/processed/ppr_geocoded_clean.gpkg"))))
...
# Save verified data
st_write(ppr_valid, 
         file.path(base_path, here(here("data/processed/ppr_geocoded_verified.gpkg"))),
         delete_layer = TRUE)
