...
ppr_clean <- read_csv(file.path(base_path, here(here("data/processed/ppr_cleaned.csv"))), show_col_types = FALSE)
...
write_csv(ppr_for_arcgis, file.path(base_path, here(here("data/processed/ppr_for_arcgis.csv"))))

# Print summary
cat("\nData prepared for ArcGIS Pro geocoding:\n")
cat(sprintf("Total records: %d\n", nrow(ppr_for_arcgis)))
cat(sprintf("Output file: %s\n", file.path(base_path, here(here("data/processed/ppr_for_arcgis.csv"))))) 
